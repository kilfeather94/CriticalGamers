<%@ Page Title ="Watch Dogs" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WD.aspx.cs" Inherits="CriticalGamers.WD" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron" id="wdjumbotron">

        <h1 align="center" style="color: #808080"><font face ="Impact"><span class="newStyle1"><strong>Watch Dogs</strong></span></font></h1>
   ...
   <asp:FormView ID="watchdogs" runat="server"
       ItemType="CriticalGamers.Models.WDGame" SelectMethod ="GetWDGame"
     ...
     <asp:FormView ID="FormView9" datasourceid="WDGameSource"  AllowPaging="true" DataKeyNames="WDGameID" emptydatatext="No summary found." runat="server"
     ...
     <asp:sqldatasource id="WDGameSource"
        selectcommand="Select [WDGameID], [Summary] From [WDGames]"
        updatecommand="Update [WDGames] Set [Summary]=@Summary Where [WDGameID]=@WDGameID"
        deletecommand="Delete From [WDGames] Where WDGameID=@WDGameID;"
